...
activities = {
    ...
    "Basketball Team": {
        "description": "Team practices and competitive league play",
    ...
    "Drama Workshop": {
        "description": "Acting, improvisation, and stage production skills",
    ...
    "Debate Team": {
        "description": "Research and competitive debate training",
